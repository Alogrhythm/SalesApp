...
public class CategoryTestCase extends EntityTestCriteria {
    ...
    private Category createCategory(Boolean isSave) throws Exception {
        ...
        category.setCategoryInformation("sclDdM3FoiQamjdd8zhM2cJESxkKE1K7HnMCDDhVQnsmackJof");
    ...
    public void test2Update() {
        try {
            ...
            category.setCategoryInformation("9OUmuhDYk7TnHWPY3hdwIRfEBRhIo8TdqtGYPaOxib7pMruUu1");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "categoryInformation", "vhP0SfD7UkfdmBD7y5xf8YUcrWkBL5VcwpYlkB8oPn7wMfMV8i0MYMuc1mMKkzTYN"));
