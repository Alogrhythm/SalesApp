...
public class SalesRegionTestCase extends EntityTestCriteria {
    ...
    private SalesRegion createSalesRegion(Boolean isSave) throws Exception {
        ...
        salesregion.setRegionname("9TOTBMe8m0MZEv4dxCKkorv03HczfBuRlLpikHq05j7Z7p9rQx");
    ...
    public void test2Update() {
        try {
            ...
            salesregion.setRegionname("veWRDDT6dEbw7YXLlO3lpQeEfh7V7R45gZnutcCTETkSG66mkx");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "regionname", "6sWP3jckOAJh3m5aeS2Jmp9Wj9qRWz0amga2FpvZzQ7bkI49u99h4y0BFMTaGyqWf"));
