...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionIcon("IfkdSnWRAjN96fWz1Vzkt030bFyZgoqBVK9yWKqmtah9jkeGWB");
        question.setQuestionDetails("HbrnI1zfAQ");
        question.setLevelid(6);
        question.setQuestion("OeVUUGtWyhWLo3nHnket0NAVaEVJgBrd5afQfC4VaLfuk4W0ru");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("w0fQkcXMxtKGzpG3xPgYrlRepnWVQPKCtNESf0MGVtK0vJyDy5");
            question.setQuestionDetails("sLaJ8P1w49");
            question.setVersionId(1);
            question.setLevelid(6);
            question.setQuestion("JHiQZ9NDXQL5afTzWsXV7y0D0M1Fjjek6mrNB4pOYMNJLcSNIn");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "ohNfmKhAz4UEQWABsAICjob6WsnUr2NaOKBfEaBWW3gBJ7rvQhCOVfsM0YbHwssT9"));
