package com.sales.app.server.businessservice.organization.contactmanagement.aspect;
...
public class BusinessServicecontactmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.sales.app.server.businessservice.organization.contactmanagement..*(..))")
