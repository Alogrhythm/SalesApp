...
public class UserRoleBridgeServiceImpl extends UserRoleBridgeService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.sales.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge> lstuserrolebridge = userRoleBridgerepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByRoleId(@RequestBody FindByBean findByBean) throws Exception {
        ...
        List<com.sales.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge> lstuserrolebridge = userRoleBridgerepo.findByRoleId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSRM224990200");
    ...
    public HttpEntity<ResponseBean> findByUserId(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        List<com.sales.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge> lstuserrolebridge = userRoleBridgerepo.findByUserId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSRM224990200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "UserRoleBridge"));
        responseBean.add("data", lstuserrolebridge);
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        com.sales.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge lstuserrolebridge = userRoleBridgerepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSRM224990200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "UserRoleBridge"));
        responseBean.add("data", lstuserrolebridge);
