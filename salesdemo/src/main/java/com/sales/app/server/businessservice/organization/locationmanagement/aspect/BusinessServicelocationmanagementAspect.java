package com.sales.app.server.businessservice.organization.locationmanagement.aspect;
...
public class BusinessServicelocationmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.sales.app.server.businessservice.organization.locationmanagement..*(..))")
