...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "20", comments = "Repository for Retailer Master table Entity", complexity = Complexity.LOW)
