package com.sales.app.server.businessservice.appbasicsetup.userrolemanagement.aspect;
...
public class BusinessServiceuserrolemanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.sales.app.server.businessservice.appbasicsetup.userrolemanagement..*(..))")
