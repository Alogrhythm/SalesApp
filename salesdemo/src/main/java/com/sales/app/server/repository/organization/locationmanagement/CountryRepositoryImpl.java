...
public class CountryRepositoryImpl extends SearchInterfaceImpl implements CountryRepository<Country> {
    ...
    public List<Country> findAll() throws Exception {
        ...
        java.util.List<com.sales.app.shared.organization.locationmanagement.Country> query = emanager.createQuery("select u from Country u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Country> save(List<Country> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.sales.app.shared.organization.locationmanagement.Country obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.sales.app.shared.organization.locationmanagement.Country s = emanager.find(com.sales.app.shared.organization.locationmanagement.Country.class, id);
        emanager.remove(s);
    ...
    public Country findById(String countryId) throws Exception {
        ...
        com.sales.app.shared.organization.locationmanagement.Country listOfCountry = (com.sales.app.shared.organization.locationmanagement.Country) query.getSingleResult();
