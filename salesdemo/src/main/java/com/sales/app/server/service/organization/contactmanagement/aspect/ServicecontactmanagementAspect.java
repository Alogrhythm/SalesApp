package com.sales.app.server.service.organization.contactmanagement.aspect;
...
public class ServicecontactmanagementAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.sales.app.server.service.organization.contactmanagement..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.sales.app.server.service.organization.contactmanagement..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.sales.app.server.service.organization.contactmanagement..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.sales.app.server.service.organization.contactmanagement..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.sales.app.server.service.organization.contactmanagement..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.sales.app.server.service.organization.contactmanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.sales.app.server.service.organization.contactmanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
