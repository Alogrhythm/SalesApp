...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "21", comments = "Repository for Brand Master table Entity", complexity = Complexity.LOW)
