...
public class QuestionServiceImpl extends QuestionService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.sales.app.shared.appbasicsetup.usermanagement.Question> lstquestion = questionrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        com.sales.app.shared.appbasicsetup.usermanagement.Question lstquestion = questionrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSUM124990200");
