...
public class CommunicationTypeServiceImpl extends CommunicationTypeService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.sales.app.shared.organization.contactmanagement.CommunicationType> lstcommunicationtype = communicationTyperepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByCommGroupId(@RequestBody FindByBean findByBean) throws Exception {
        ...
        List<com.sales.app.shared.organization.contactmanagement.CommunicationType> lstcommunicationtype = communicationTyperepo.findByCommGroupId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCM124990200");
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        com.sales.app.shared.organization.contactmanagement.CommunicationType lstcommunicationtype = communicationTyperepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCM124990200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "CommunicationType"));
        responseBean.add("data", lstcommunicationtype);
