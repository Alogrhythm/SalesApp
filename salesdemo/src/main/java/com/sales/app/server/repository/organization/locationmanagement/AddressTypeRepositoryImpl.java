...
public class AddressTypeRepositoryImpl extends SearchInterfaceImpl implements AddressTypeRepository<AddressType> {
    ...
    public List<AddressType> findAll() throws Exception {
        ...
        java.util.List<com.sales.app.shared.organization.locationmanagement.AddressType> query = emanager.createQuery("select u from AddressType u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<AddressType> save(List<AddressType> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.sales.app.shared.organization.locationmanagement.AddressType obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.sales.app.shared.organization.locationmanagement.AddressType s = emanager.find(com.sales.app.shared.organization.locationmanagement.AddressType.class, id);
        emanager.remove(s);
    ...
    public AddressType findById(String addressTypeId) throws Exception {
        ...
        com.sales.app.shared.organization.locationmanagement.AddressType listOfAddressType = (com.sales.app.shared.organization.locationmanagement.AddressType) query.getSingleResult();
