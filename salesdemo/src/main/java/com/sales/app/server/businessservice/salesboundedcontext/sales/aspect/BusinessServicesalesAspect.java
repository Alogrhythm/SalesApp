package com.sales.app.server.businessservice.salesboundedcontext.sales.aspect;
...
public class BusinessServicesalesAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.sales.app.server.businessservice.salesboundedcontext.sales..*(..))")
