package com.sales.app.server.businessservice.appbasicsetup.usermanagement.aspect;
...
public class BusinessServiceusermanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.sales.app.server.businessservice.appbasicsetup.usermanagement..*(..))")
